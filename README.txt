...
-> parametre = script_positives.py = nombre de positives obtenu a partir de photos originales

# /!\ Ne pas oublier de changer les formats dans le code pour la récuperation des fichiers

# commande system en lien avec windows = os.system()
